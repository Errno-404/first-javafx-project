...
class GrassFieldTest {
    ...
    void canMoveTo() {
        ...
        // zwierzęta mogą wejść na trawę
        Vector2d grassPos = map.grasses.get(0).getPosition();
        assertTrue(map.canMoveTo(grassPos));
    ...
    void objectAt() {
        ...
        Vector2d pos = map.grasses.get(4).getPosition();
